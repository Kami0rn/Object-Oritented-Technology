...
public static void bill(Order o) {
    ...
    if(o.customer.getCtype().equals("General")){
        System.out.printf("%s[%s] have pay %.1f Bath\n",o.customer.getCname(),o.customer.getCtype(),o.getTotalPrice());
    }
    else{
        System.out.printf("%s[%s] have got a discount of %.1f Bath and have to pay %.1f Bath\n",o.customer.getCname(),o.customer.getCtype(),o.getDiscount(),o.getTotalPrice());
    }
    System.out.println();
}
}