...
public class MainClass {
    public static void main(String[] args) {
        ...
        persons[0] = new Lecturer("Benedict Cumberbatch", "male", 35,"Associate Professor", 90000, "Computer Engineering");
        persons[1] = new Researcher("Emma Watson", "female", 30, "full-time", 35000,"Technopolis");
        persons[2] = new Lecturer("Kate Winslet", "female", 40, "Assistant Professor",65000, "Food Technology");
